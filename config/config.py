...
UPSTREAM_REPO = getenv(
    ...
    "https://github.com/legendaditya03/Pusu-Music",
...
SUPPORT_CHANNEL = getenv(
    ...
    "SUPPORT_CHANNEL", None) # Example:- https://t.me/pusu_world01

SUPPORT_GROUP = getenv(

    "SUPPORT_GROUP", None)  # Example:- https://t.me/pusu_world
...
VIDEO_STREAM_LIMIT = int(getenv("VIDEO_STREAM_LIMIT", "12"))
